...
- **UI components** → build to the **Design System Contract**
  (`skill://saki-builder-runtime/docs/design-system-contract.md`): tokens-only (Part B), every
...
- Dir: `~/.omp/agent/agent-memory/product-engineer/`
- Protocol: `skill://saki-builder-runtime/docs/agent-memory-protocol.md` (load on demand)
