...
### 1. Locate Context
Use the `glob` tool to find the active feature directory inside `.saki/.output/features/`. Use the `read` tool to read the `pitch.md` or requirements document located there.
