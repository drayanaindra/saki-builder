...
`skill://rplan/SKILL.md:350` already blocks on it and must keep blocking. Never fabricate it, never
...
`skill://saki-builder-runtime/docs/manual-chain-resume.md` (`PLAN_FILE` = the reviewed plan). Skip silently
...
```
.omp/skills/rplan-review/SKILL.md
```
