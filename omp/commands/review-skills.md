...
When the user says "review my skills" or "prune skills", perform this audit on all files in `~/.omp/agent/skills/` (excluding this file).

## Audit Process

1. **Read every skill file** in `~/.omp/agent/skills/`
