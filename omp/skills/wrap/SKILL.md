...
ceiling): `skill://saki-builder-runtime/docs/project-context-contract.md`.
...
`skill://saki-builder-runtime/docs/manual-chain-resume.md`. Absent or error → skip silently; it never
affects convergence.
