...
runner so the same skill works under Claude Code, OpenCode, Codex, and Gemini/Antigravity.
...
Check `.omp/personas/*.md`. If it exists, read the relevant persona(s) and use them to
...
Contract: `skill://saki-builder-runtime/docs/project-context-contract.md`.
