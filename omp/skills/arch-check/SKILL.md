...
type: analysis
trigger: "arch check, architecture tier, should this be clean architecture, stage 2 to 3, when to use DDD, is this module too big, module outgrowing its stage"
user-invocable: true
---
...
`skill://saki-builder-runtime/docs/modular-architecture.md` (§Transition Triggers). That doc is the
...
Read `skill://saki-builder-runtime/docs/modular-architecture.md` §Transition Triggers. Confirm the
...
```bash
bash ${SAKI_PLUGIN_ROOT}/omp/skills/arch-check/detect.sh [repo-root]
```
