...
Structure your feedback as a design director would. Write the report to the current phase's output directory (e.g., `.saki/.output/features/<feature-dir>/REVIEW_REPORT.md`) using your Write tool.
