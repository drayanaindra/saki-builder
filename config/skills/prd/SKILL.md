...
This PRD will be used as input for the Saki development workflow, where each user story will become one atomic task handled by an AI agent in a single iteration.
...
6. After approval, convert to `.saki/saki-tasks.json` format:
...
- [ ] .saki/saki-tasks.json updated with new tasks
