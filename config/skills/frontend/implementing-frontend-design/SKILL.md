...
Check the Architecture Plan from Phase 7 (locate it within .saki/.output/features/ using your search tools) or AGENTS.md for this context. If not present, infer it from existing codebase files (like DESIGN.md or a global theme file).
